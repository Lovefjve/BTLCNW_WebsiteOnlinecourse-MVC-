        ...
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>/admin/categories/edit?id=<?php echo $category['id']; ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="4" style="width:100%; padding:10px; border:1px solid #ddd; border-radius:6px"><?php echo htmlspecialchars($data['description'] ?? $category['description']); ?></textarea>
