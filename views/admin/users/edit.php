            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="status" id="status" required>
                        <option value="active" <?php echo (!empty($data['status']) && $data['status'] === 'active') ? 'selected' : (isset($editUser['status']) && $editUser['status'] === 'active' ? 'selected' : ''); ?>>Kích hoạt</option>
                        <option value="inactive" <?php echo (!empty($data['status']) && $data['status'] === 'inactive') ? 'selected' : (isset($editUser['status']) && $editUser['status'] === 'inactive' ? 'selected' : ''); ?>>Vô hiệu hóa</option>
                    </select>
                </div>
