...
class CourseController {
    ...
    // ========== DANH SÁCH KHÓA HỌC (từ courses() trong InstructorController) ==========
    public function index() {
        $instructor_id = $_SESSION['user_id']; // Lấy từ session thay vì getFirstInstructorId()
    ...
    // ========== TẠO KHÓA HỌC (từ createCourse() trong InstructorController) ==========
    ...
    // ========== LƯU KHÓA HỌC (từ store() trong InstructorController) ==========
    public function store() {
        ...
        header('Location: ?c=course&a=index'); // Sửa: về course index thay vì instructor courses
        exit;
    }
    
    // ========== SỬA KHÓA HỌC (từ edit() trong InstructorController) ==========
    ...
    // ========== CẬP NHẬT KHÓA HỌC (từ update() trong InstructorController) ==========
    public function update() {
        ...
        header('Location: ?c=course&a=index'); // Sửa: về course index
        exit;
    }
    
    // ========== XÓA KHÓA HỌC (từ delete() trong InstructorController) ==========
